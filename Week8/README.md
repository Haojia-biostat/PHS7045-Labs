...
```
    ...
    Unit: seconds
                    ...
                    dist(x) 8.742453 8.742453 8.742453 8.742453 8.742453 8.742453
     dist_par(x, cores = 1) 2.802786 2.802786 2.802786 2.802786 2.802786 2.802786
     dist_par(x, cores = 4) 1.582782 1.582782 1.582782 1.582782 1.582782 1.582782
     dist_par(x, cores = 8) 1.675232 1.675232 1.675232 1.675232 1.675232 1.675232
     neval
         1
         1
         1
...
```
    ...
    Unit: relative
                       expr      min       lq     mean   median       uq      max
                    dist(x) 5.523473 5.523473 5.523473 5.523473 5.523473 5.523473
     dist_par(x, cores = 1) 1.770797 1.770797 1.770797 1.770797 1.770797 1.770797
     dist_par(x, cores = 4) 1.000000 1.000000 1.000000 1.000000 1.000000 1.000000
     dist_par(x, cores = 8) 1.058410 1.058410 1.058410 1.058410 1.058410 1.058410
     neval
         1
         1
         1
